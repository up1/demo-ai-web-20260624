...
| Department name (หน่วยงาน) | string | Yes | The department that created the document |
| Person in Charge (employee name) (ผู้รับผิดชอบ) | string | Yes | The employee responsible for the document |
